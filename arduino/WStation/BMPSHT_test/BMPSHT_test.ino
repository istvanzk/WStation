/* SFE_BMP180 + SHT15 test sketch
 
Sketch uses 10,026 bytes (32%) of program storage space. Maximum is 30,720 bytes.
...
1) the SFE_BMP180 library to read the Bosch BMP180 barometric pressure sensor.
https://www.sparkfun.com/products/11824
2) the SHT1x library to get the temperature in F or C and humidity from SHT15 humidity sensor.
...
BMP data:
 provided altitude: 40 meters, 131 feet
 temperature: 19.89 C, 67.81 F
 absolute pressure: 1010.98 mb, 29.86 inHg
 relative (sea-level) pressure: 1015.79 mb, 30.00 inHg
 computed altitude: 40 meters, 131 feet
SHT data:
 temperature: 19.68 C, 67.48 F
 humidity: 69.84%
